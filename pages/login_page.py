...
class LoginPage(BasePage):
    # Zad 2 Subtask 3: Dodawanie selektorów do projektu: uzupełnienie tej strony o elementy
    ...
    # login_url = ('https://scouts-test.futbolkolektyw.pl/en') zbędny - mógł być użyty do get_page_title ale lepiej korzystać z bardziej uniwersalnej opcji gdzie driver pobiera url strony na której testuje
    ...
    def type_in_password(self, password):  # zad 3 sub 1
        self.field_send_keys(self.password_field_xpath, password)

    def click_sign_in(self):  # zad 3 sub 1
        self.click_on_the_element(self.sign_in_button_xpath)

    def check_title_of_page(self):  # zad 3 sub 3
        assert self.get_page_title() == self.expected_title  # sam pobiera url ze strony na której testuje

    def assert_header_text(self):  # zad 3 sub 5*
